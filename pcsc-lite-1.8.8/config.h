...
/* pcscd filename */
#define PCSCD_BINARY "/system/bin/pcscd"

/* Enabled PC/SC lite features */
#define PCSCLITE_FEATURES " Linux i686-pc-linux-gnu serial usb usbdropdir=/data/system/pcsc/usb ipcdir=/data/system/pcsc/ipc configdir=/vendor/etc/pcsc"
...
#define USE_IPCDIR "/data/system/pcsc/ipc"
